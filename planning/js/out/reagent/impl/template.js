...
var G__22478 = o;
(G__22478[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__22482 = o;
(G__22482[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__22487 = props;
var G__22487__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__22487,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__22487);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__22487__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__22488){
...
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__22489,map__22489__$1,props,class$){
return (function (c){
...
});})(map__22489,map__22489__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__22491){
...
var on_write = cljs.core.get.call(null,map__22492__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__22492,map__22492__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__22492,map__22492__$1,on_write))
);
} else {
...
var G__22495 = jsprops;
(G__22495["defaultValue"] = value);

(G__22495["onChange"] = ((function (G__22495,v,value,on_change){
return (function (p1__22494_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__22494_SHARP_);
});})(G__22495,v,value,on_change))
);
...
var vec__22498 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__22498,(0),null);
var id = cljs.core.nth.call(null,vec__22498,(1),null);
var class$ = cljs.core.nth.call(null,vec__22498,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___22502 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___22502 == null)){
} else {
var key_22503 = temp__5461__auto___22502;
(jsprops["key"] = key_22503);
}
...
var temp__5461__auto___22504 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5461__auto___22504 == null)){
} else {
var key_22505 = temp__5461__auto___22504;
reagent.impl.template.oset.call(null,jsprops,"key",key_22505);
}
...
var G__22506 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__22506["name"] = c);
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq22509){
var G__22510 = cljs.core.first.call(null,seq22509);
var seq22509__$1 = cljs.core.next.call(null,seq22509);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22510,seq22509__$1);
});
...
break;
default:
var G__22516 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__22516;
continue;
...
var n__4518__auto___22518 = a.length;
var i_22519 = (0);
while(true){
if((i_22519 < n__4518__auto___22518)){
(a[i_22519] = reagent.impl.template.as_element.call(null,(a[i_22519])));
...
var a = cljs.core.into_array.call(null,s);
var n__4518__auto___22521 = a.length;
var i_22522 = (0);
while(true){
if((i_22522 < n__4518__auto___22521)){
var val_22523 = (a[i_22522]);
if(((cljs.core.vector_QMARK_.call(null,val_22523)) && ((reagent.impl.template.key_from_vec.call(null,val_22523) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_22522] = reagent.impl.template.as_element.call(null,val_22523));
...
var ctx = ({});
var vec__22525 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__22525,(0),null);
var derefed = cljs.core.nth.call(null,vec__22525,(1),null);
...
var G__22528 = (cljs.core.count.call(null,argv) - first_child);
switch (G__22528) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__22528){
...
//# sourceMappingURL=template.js.map?rel=1542476941024
