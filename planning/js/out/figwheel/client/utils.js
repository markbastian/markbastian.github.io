...
return (new CustomEvent(event_name,(function (){var obj27741 = {"detail":data};
return obj27741;
})()));
} else {
...
var f = (function (){var pred__27748 = cljs.core._EQ_;
var expr__27749 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__27748.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__27749))){
return ((function (pred__27748,expr__27749){
return (function (p1__27742_SHARP_){
return console.warn(p1__27742_SHARP_);
});
;})(pred__27748,expr__27749))
} else {
if(cljs.core.truth_(pred__27748.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__27749))){
return ((function (pred__27748,expr__27749){
return (function (p1__27743_SHARP_){
return console.debug(p1__27743_SHARP_);
});
;})(pred__27748,expr__27749))
} else {
if(cljs.core.truth_(pred__27748.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__27749))){
return ((function (pred__27748,expr__27749){
return (function (p1__27744_SHARP_){
return console.error(p1__27744_SHARP_);
});
;})(pred__27748,expr__27749))
} else {
return ((function (pred__27748,expr__27749){
return (function (p1__27745_SHARP_){
return console.log(p1__27745_SHARP_);
});
;})(pred__27748,expr__27749))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__27752){
...
var opts = map__27753__$1;
var eval_fn = cljs.core.get.call(null,map__27753__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__27755_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__27757,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1542520741277
