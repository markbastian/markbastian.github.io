...
return (new CustomEvent(event_name,(function (){var obj29384 = {"detail":data};
return obj29384;
})()));
} else {
...
var f = (function (){var pred__29391 = cljs.core._EQ_;
var expr__29392 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__29391.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__29392))){
return ((function (pred__29391,expr__29392){
return (function (p1__29385_SHARP_){
return console.warn(p1__29385_SHARP_);
});
;})(pred__29391,expr__29392))
} else {
if(cljs.core.truth_(pred__29391.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__29392))){
return ((function (pred__29391,expr__29392){
return (function (p1__29386_SHARP_){
return console.debug(p1__29386_SHARP_);
});
;})(pred__29391,expr__29392))
} else {
if(cljs.core.truth_(pred__29391.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__29392))){
return ((function (pred__29391,expr__29392){
return (function (p1__29387_SHARP_){
return console.error(p1__29387_SHARP_);
});
;})(pred__29391,expr__29392))
} else {
return ((function (pred__29391,expr__29392){
return (function (p1__29388_SHARP_){
return console.log(p1__29388_SHARP_);
});
;})(pred__29391,expr__29392))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__29395){
...
var eval_fn = cljs.core.get.call(null,map__29396__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__29398_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__29400,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1542476947833
