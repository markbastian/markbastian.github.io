...
var G__22519 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__22519;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__22520 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__22520,ch);
...
if(("\\" === ch__$1)){
var ch_22521__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_22521__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_22521__$2);
} else {
}

var G__22522 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__22522;
continue;
}
}
...
var G__22533 = cljs.core.conj_BANG_.call(null,a,form);
a = G__22533;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__22534 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__22535 = true;
cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__22535;

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__22534;
}});
/**
...
var vec__22539 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__22539,(0),null);
var end_column = cljs.core.nth.call(null,vec__22539,(1),null);
...
var vec__22542 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__22542,(0),null);
var start_column = cljs.core.nth.call(null,vec__22542,(1),null);
...
var vec__22545 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__22545,(0),null);
var end_column = cljs.core.nth.call(null,vec__22545,(1),null);
...
var sb = (function (){var G__22554 = (new goog.string.StringBuffer());
G__22554.append(initch);
...
var G__22556 = (function (){var G__22555 = sb;
G__22555.append(ch);

return G__22555;
})();
var G__22557 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__22556;
ch = G__22557;
continue;
}
...
switch (G__22560) {
case "\\":
var G__22564 = (function (){var G__22561 = sb;
G__22561.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__22561;
})();
var G__22565 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__22564;
ch = G__22565;
continue;
...
break;
default:
var G__22566 = (function (){var G__22562 = sb;
G__22562.append(ch);

return G__22562;
})();
var G__22567 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__22566;
ch = G__22567;
continue;
...
var vec__22568 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__22568,(0),null);
var end_column = cljs.core.nth.call(null,vec__22568,(1),null);
...
var vec__22571 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__22571,(0),null);
var column = cljs.core.nth.call(null,vec__22571,(1),null);
...
var vec__22576 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__22576,(0),null);
var column = cljs.core.nth.call(null,vec__22576,(1),null);
...
var vec__22581 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__22581,(0),null);
var column = cljs.core.nth.call(null,vec__22581,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__22586 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__22586,(0),null);
var start_column = cljs.core.nth.call(null,vec__22586,(1),null);
...
var vec__22589 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__22589,(0),null);
var end_column = cljs.core.nth.call(null,vec__22589,(1),null);
...
var G__22592 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__22592,true,null,opts,pending_forms);
...
var G__22593 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__22593)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__22593)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__22593)){
...
var _STAR_suppress_read_STAR__orig_val__22594 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__22595 = true;
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__22595;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__22594;
}});
...
var _STAR_suppress_read_STAR__orig_val__22602 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__22603 = (function (){var or__4047__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
...
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__22603;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__22602;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__22604 = cljs.tools.reader.arg_env;
var arg_env_temp_val__22605 = cljs.core.sorted_map.call(null);
cljs.tools.reader.arg_env = arg_env_temp_val__22605;

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__22606 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__22606,"(");
...
var G__22607 = (i + (1));
var G__22608 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4047__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env_orig_val__22604;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__22609 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__22609);
...
var G__22610 = cljs.core.next.call(null,s__$1);
var G__22611 = ret;
s__$1 = G__22610;
r = G__22611;
continue;
...
var G__22612 = cljs.core.next.call(null,s);
var G__22613 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__22612;
key_vals = G__22613;
continue;
} else {
...
var gensym_env_orig_val__22617 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__22618 = cljs.core.PersistentArrayMap.EMPTY;
cljs.tools.reader.gensym_env = gensym_env_temp_val__22618;
...
}finally {cljs.tools.reader.gensym_env = gensym_env_orig_val__22617;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__22619 = token;
var G__22619__$1 = (((G__22619 == null))?null:cljs.core.subs.call(null,G__22619,(1)));
var G__22619__$2 = (((G__22619__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__22619__$1));
var G__22619__$3 = (((G__22619__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__22619__$2));
var G__22619__$4 = (((G__22619__$3 == null))?null:cljs.core.symbol.call(null,G__22619__$3));
if((G__22619__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__22619__$4);
}
})():(function (){var G__22620 = token;
var G__22620__$1 = (((G__22620 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__22620));
if((G__22620__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__22620__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
}catch (e22627){if((e22627 instanceof Error)){
var e = e22627;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__22631,reader){
var map__22632 = p__22631;
var map__22632__$1 = (((((!((map__22632 == null))))?(((((map__22632.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__22632.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__22632):map__22632);
var opts = map__22632__$1;
var eof = cljs.core.get.call(null,map__22632__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq22638){
var G__22639 = cljs.core.first.call(null,seq22638);
var seq22638__$1 = cljs.core.next.call(null,seq22638);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22639,seq22638__$1);
});


//# sourceMappingURL=reader.js.map?rel=1542520736217
